...
POLICY_DEVICE = "cuda"
POLICY_REPO_ID = "guningquan/diffusion_policy"
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Train a policy (default Diffusion) using the same pipeline as lerobot_train.py.",
    )
